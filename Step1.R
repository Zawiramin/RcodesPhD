...
#pisa.var.label(student.file = c("CY6_MSU_STU_QQQ.sav"),name = "StudentQ18 Label")
...
#pisaCPS2015 <- read.spss("CY6_MS_CM2_STU_CPS.sav", to.data.frame = TRUE,stringsAsFactors=F, na.strings=c(NA,"NA"," NA"))
...
#fwrite(pisaCPS2015,file = "pisaCPS2015.csv")
#pisa15Tch <- fread("pisaTch2015.csv",na.strings = "")
#pisa15CPS <- fread("pisaCPS2015.csv",na.strings = "")
